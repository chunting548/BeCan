...
public class MainActivity extends AppCompatActivity
{
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState)
  {
    ...
    mVenueBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.erea_icon);
  ...
  public void toggleAdjustMode(View v)
  {
    ...
    adjustModeButton.setBackgroundResource(mAdjustMode ?
                                           R.drawable.ic_focus_icon_1 :
                                           R.drawable.ic_focus_icon_2);
  ...
  private boolean loadSubLocation(int index)
  {
    ...
    if (mCurrentSubLocationIndex > 0)
    {
      ...
      //mPrevFloorView.setBackgroundColor(Color.parseColor("@android:color/transparent" ));
    }
    else
    {
    ...
    if (mCurrentSubLocationIndex + 1 < mLocation.subLocations.size())
    {
      ...
      //mNextFloorView.setBackgroundColor(Color.parseColor("@android:color/transparent" ));
    }
    else
    {
